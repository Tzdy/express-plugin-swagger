...
declare namespace TySwagger {
    ...
    type DataType = 'integer' | 'string' | 'number' | 'boolean' | 'array' | 'object'
    ...
    interface TySwaggerUserOptions {
        ...
        securityDefinitions?: Record<string, SecurityBasic | SecurityApiKey | SecurityOAuth2>;
    }
    ...
    interface TySwaggerDoc extends TySwaggerUserOptions, TySwaggerInternalOptions { }
